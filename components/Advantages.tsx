            ...
            <div className="container mx-auto px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    >
                        ...
                        <h3 className="text-5xl font-bold my-8">HOUSEMOOD</h3>
                    ...
                    <AnimateOnScroll 
                      ...
                      delay={0.1}
                    >
                        <img src="https://images.unsplash.com/photo-1617103995836-543657753716?q=80&w=600&auto=format&fit=crop" alt="Unique Design" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"/>
                    ...
                    >
                        <img src="https://images.unsplash.com/photo-1524758631624-e2822e304c36?q=80&w=600&auto=format&fit=crop" alt="Strong Portfolio" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"/>
                    ...
                    <AnimateOnScroll 
                      ...
                      delay={0.1}
                    >
                        <img src="https://images.unsplash.com/photo-1519710164239-da123dc03ef4?q=80&w=600&auto=format&fit=crop" alt="Client-oriented" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"/>
                    ...
                    <AnimateOnScroll 
                      ...
                      delay={0.2}
                    >
                        <img src="https://images.unsplash.com/photo-1533090481720-856c6e3c1fdc?q=80&w=600&auto=format&fit=crop" alt="Attention to Detail" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"/>
